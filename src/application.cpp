/*
 * SPDX-FileCopyrightText: 2023 chang2005 <389574063@qq.com>
...
static QApplication *createApplication(int &argc, char **argv, const QString &applicationName)
{
    ...
    QApplication::setOrganizationName("longos");
    QApplication::setApplicationName(applicationName);
    QApplication::setOrganizationDomain("longos.com");
    QApplication::setApplicationDisplayName("Video Player");
    QApplication::setWindowIcon(QIcon::fromTheme("long-videoplayer"));
    ...
    : m_app(createApplication(argc, argv, applicationName))
{
    ...
    QString mspris2Name(QStringLiteral("org.mpris.MediaPlayer2.long.videoplayer"));
    ...
    // Translations
    QLocale locale;
    QString qmFilePath = QString("%1/%2.qm").arg("/usr/share/long-videoplayer/translations/").arg(locale.name());
