    ...
    RowLayout {
        ...
        Label {
            ...
            font.pointSize: (rootWindow.isFullScreen() && playList.bigFont)
                            ? LongUI.Units.gridUnit
                            : LongUI.Units.gridUnit - 6
        ...
        Label {
            ...
            color: isPlaying ? LongUI.Theme.highlightColor : LongUI.Theme.textColor
            text: model.name
            layer.enabled: true
            Layout.fillWidth: true
            // Layout.leftMargin: PlaylistSettings.showRowNumber || isPlaying ? 0 : LongUI.Units.largeSpacing
        }
        ...
        Label {
            ...
            font.pointSize: (rootWindow.isFullScreen() && playList.bigFont)
                            ...
                            : LongUI.Units.gridUnit - 6
            horizontalAlignment: Qt.AlignCenter
            Layout.margins: LongUI.Units.largeSpacing
        }
    }
