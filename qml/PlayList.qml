...
Item {
    id: control
    height: mpv.height - LongUI.Units.largeSpacing * 2
    width: LongUI.Units.gridUnit * 16
    z: 9999
    x: parent.width
    y: LongUI.Units.largeSpacing
    state: "hidden"
    ...
    ShaderEffectSource {
     ...
     states: [
         ...
         State {
             name : "visible"
             PropertyChanges { target: control; x: position === "right" ? parent.width - control.width - LongUI.Units.largeSpacing : 0 }
